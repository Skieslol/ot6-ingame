...
struct UGA_Ninja_PoisonedBlade_C_K2_ShouldAbilityRespondToEvent_Params
{
...
struct UGA_Ninja_PoisonedBlade_C_K2_ActivateAbilityFromEvent_Params
{
	struct FGameplayEventData                          EventData;                                                 // (ConstParm, Parm, OutParm, ReferenceParm)
};

// Function GA_Ninja_PoisonedBlade.GA_Ninja_PoisonedBlade_C.ExecuteUbergraph_GA_Ninja_PoisonedBlade
struct UGA_Ninja_PoisonedBlade_C_ExecuteUbergraph_GA_Ninja_PoisonedBlade_Params
{
