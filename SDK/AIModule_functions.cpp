...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function AIModule.AIController.OnUnpossess");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function AIModule.EQSGameplayDebuggerObject.OnCycleDetailsView");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function AIModule.NavMeshGameplayDebuggerObject.ServerDiscardNavmeshData");
