...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass GE_Constructor_KineticOverloadDamageSlowTrigger.GE_Constructor_KineticOverloadDamageSlowTrigger_C");
		return ptr;
	}
