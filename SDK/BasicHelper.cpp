...
namespace CG
{
typedef void(__thiscall* fToString)(const FName*, FString&);
fToString _ToString = reinterpret_cast<fToString>(reinterpret_cast<uintptr_t>(GetModuleHandle(0)) + 0x90F370);
...
bool InitSdk()
{
	return InitSdk("FortniteClient-Win64-Shipping.exe", 0x2DC3AAC, 0x2DBC5A8);
}
#endif
//---------------------------------------------------------------------------
