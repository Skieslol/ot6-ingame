...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GAT_TriggeredAbility.GAT_TriggeredAbility_C.K2_ActivateAbilityFromEvent");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GAT_TriggeredAbility.GAT_TriggeredAbility_C.ExecuteUbergraph_GAT_TriggeredAbility");
