...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.Set Material Pararmeters");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.init a new number set");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.UserConstructionScript");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.OnNewDamageNumber");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.ExecuteUbergraph_ImpactNumbers");
