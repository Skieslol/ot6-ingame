...
{
	unsigned char                                      bOverride_LPVIntensity : 1;                                // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVDirectionalOcclusionIntensity : 1;            // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVDirectionalOcclusionRadius : 1;               // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVDiffuseOcclusionExponent : 1;                 // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVSpecularOcclusionExponent : 1;                // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVDiffuseOcclusionIntensity : 1;                // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVSpecularOcclusionIntensity : 1;               // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVSize : 1;                                     // 0x0000(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVSecondaryOcclusionIntensity : 1;              // 0x0001(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVSecondaryBounceIntensity : 1;                 // 0x0001(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVGeometryVolumeBias : 1;                       // 0x0001(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVVplInjectionBias : 1;                         // 0x0001(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_LPVEmissiveInjectionIntensity : 1;               // 0x0001(0x0001) BIT_FIELD (BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_UC78[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
