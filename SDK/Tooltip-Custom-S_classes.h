...
public:
	...
	struct FText                                       HeaderText;                                                // 0x01DC(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible, ExposeOnSpawn)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tooltip-Custom-S.Tooltip-Custom-S_C");
		return ptr;
	}
