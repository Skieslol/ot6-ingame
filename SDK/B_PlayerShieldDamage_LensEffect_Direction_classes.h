...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass B_PlayerShieldDamage_LensEffect_Direction.B_PlayerShieldDamage_LensEffect_Direction_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_PlayerShieldDamage_LensEffect_Direction(int EntryPoint);
};
